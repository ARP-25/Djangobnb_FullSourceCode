    ...
    return (
        <>
            <div className="max-h-[400px] overflow-auto flex flex-col space-y-4">
                <div className="w-[80%] py-4 px-6 rounded-xl bg-gray-200 break-words">
                    <p className="font-bold text-gray-500">John Doe</p>
                    <p className="">Mesasdasdafgeadsadawsdawd</p>
                </div>
                <div className="w-[80%] ml-[20%] py-4 px-6 rounded-xl bg-blue-200 break-words">
                    <p className="font-bold text-gray-500">ARP-25</p>
                    <p className="">Mesasdasdafgeadsadawsdawd</p>
                    <p className="">Mesasdasdafgeadsadawsdawd</p>
                    <p className="">Mesasdasdafgeadsadawsdawd</p>
                </div>
